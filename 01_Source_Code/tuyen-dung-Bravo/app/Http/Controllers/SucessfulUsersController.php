...
class SucessfulUsersController extends Controller
{
    /**
    ...
    {
        $users = SucessfulUsers::paginate(10);
        return view('admin.sucessfulUsers',compact('users'));
    }
