<div class="col-lg-3">
    <div class="card position-sticky top-1">
        <ul class="nav flex-column bg-white border-radius-lg p-3">
            <li class="nav-item">
                <a class="nav-link text-body" data-scroll="" @if (auth()->user()->role->name=='administrator' || auth()->user()->role->name=='user') href="{{route('user.show',auth()->user()->slug)}}" @else href="{{route('company.show',auth()->user()->slug)}}" @endif>
                    <div class="icon me-2">
            ...
            <li class="nav-item pt-2">
                <a class="nav-link text-body" data-scroll="" @if (auth()->user()->role->name=='administrator' || auth()->user()->role->name=='user') href="{{route('user.edit')}}" @else href="{{route('company.edit')}}" @endif>
                    <div class="icon me-2">
            ...
            <li class="nav-item pt-2">
                <a class="nav-link text-body" data-scroll="" @if (auth()->user()->role->name=='administrator' || auth()->user()->role->name=='user') href="{{route('user.password.edit')}}" @else href="{{route('company.password.edit')}}" @endif>
                    <div class="icon me-2">
            ...
            <li class="nav-item pt-2">
                <a class="nav-link text-body" data-scroll="" @if (auth()->user()->role->name=='administrator' || auth()->user()->role->name=='user') href="{{route('user.photo.edit')}}" @else href="{{route('company.photo.edit')}}"  @endif >
                    <div class="icon me-2">
                        <svg class="text-dark mb-1" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item pt-2">
                <a class="nav-link text-body" data-scroll="" @if (auth()->user()->role->name=='administrator' || auth()->user()->role->name=='user') href="{{route('user.username.edit')}}" @else href="{{route('company.username.edit')}}"  @endif >
                    <div class="icon me-2">
                        <svg class="text-dark mb-1" width="16px" height="16px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
