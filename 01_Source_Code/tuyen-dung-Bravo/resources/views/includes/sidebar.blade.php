...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        @if (auth()->user()->role->name=='administrator' || auth()->user()->role->name=='user') href="{{route('user.show',auth()->user()->slug)}}" @else href="{{route('company.show',auth()->user()->slug)}}"  @endif>
            <img src="{{asset('/assets/img/logos/logo Bravo.png')}}" class="navbar-brand-img h-100" alt="Bravo logo">
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link " @if (auth()->user()->role->name=='administrator' || auth()->user()->role->name=='user') href="{{route('user.show',auth()->user()->slug)}}" @else href="{{route('company.show',auth()->user()->slug)}}"  @endif>
            ...
            @if (auth()->user()->role->name =='user')
                <li class="nav-item">
                    <a class="nav-link {{Route::is('jobs.*') ? 'active' : ''}}" href="{{route('jobs.request')}}">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Job request</span>
                    </a>
                </li>
            @endif
            ...
            @if (auth()->user()->role->name =='company')
                <li class="nav-item">
                    <a class="nav-link {{Route::is('response.*') ? 'active' : ''}} " href="{{route('response.company.job')}}">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-columns" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M0 .5A.5.5 0 0 1 .5 0h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 0 .5Zm13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm-13 2A.5.5 0 0 1 .5 2h8a.5.5 0 0 1 0 1h-8a.5.5 0 0 1-.5-.5Zm13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm-13 2A.5.5 0 0 1 .5 4h10a.5.5 0 0 1 0 1H.5a.5.5 0 0 1-.5-.5Zm13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm-13 2A.5.5 0 0 1 .5 6h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm-13 2A.5.5 0 0 1 .5 8h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm-13 2a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5Zm13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm-13 2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm-13 2a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H.5a.5.5 0 0 1-.5-.5Zm13 0a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Z"/>
                            </svg>
                        </div>
                        <span class="nav-link-text ms-1">Job response</span>
                    </a>
                </li>
            @endif
            ...
            <li class="nav-item mt-3">
                ...
                <li class="nav-item">
                    <a class="nav-link {{Route::is('admin.sucessful.users') ? 'active' : ''}}" href="{{route('admin.sucessful.users')}}">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>office</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Sucessful Users</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{Route::is('languages') ? 'active' : ''}}" href="{{route('languages')}}">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>office</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#pagesExamples" class="nav-link {{Route::is('admin.users') || Route::is('admin.companies') || Route::is('admin.admins') ? 'active' : ''}}" aria-controls="pagesExamples" role="button" aria-expanded="false">
                    ...
                    <div class="collapse " id="pagesExamples">
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{Route::is('admin.companies') ? 'active' : ''}}" href="{{route('admin.companies')}}">
                                    {{--                                <span class="sidenav-mini-icon"> D </span>--}}
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#profile-button" class="nav-link {{Route::is('user.*') || Route::is('company.*') ? 'active' : ''}}" aria-controls="pagesExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" @if (auth()->user()->role->name=='administrator' || auth()->user()->role->name=='user') href="{{route('user.edit')}}" @else href="{{route('company.edit')}}" @endif>
                                {{--                                <span class="sidenav-mini-icon"> D </span>--}}
                                <span class="sidenav-normal"> Preferences </span>
                            </a>
                        </li>
            ...
            @if (auth()->user()->role->name=='company' && auth()->user()->email_verified_at != null && auth()->user()->is_approved)
                <li class="nav-item">
